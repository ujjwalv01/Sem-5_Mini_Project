      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-16 bg-white overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="flex bg-gray-100 p-1 rounded-xl mb-8">
            <button onClick={() => router.push(`/signin?callbackUrl=${encodeURIComponent(callbackUrl)}`)} className="flex-1 py-2.5 text-sm font-semibold rounded-lg transition-all duration-200 text-gray-500 hover:text-gray-700">
              Sign In
            </button>
